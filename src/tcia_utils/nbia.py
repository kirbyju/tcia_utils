...
def setApiUrl(endpoint, api_url):
    ...
    advancedEndpoints = ["getModalityValuesAndCounts", "getBodyPartValuesAndCounts", 
                         ...
                         "getCollectionValuesAndCounts", "getSimpleSearchCriteriaValues"]
...
def getSimpleSearchCriteriaValues(
    collections = [],
    species = [],
    modalities = [],
    bodyParts = [],
    ...
    Example call: getSimpleSearchCriteriaValues(collections=["TCGA-UCEC", "4D-Lung"], modalities=["CT"])
    """

    endpoint = "getSimpleSearchCriteriaValues"
    criteriaTypeIndex = 0
    options = {}
